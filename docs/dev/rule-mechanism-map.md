...
| 7 | Recurring task → skill; failed skill → improve | `creating-skills` skill; generic improvements go template-first (project-skill shadow locally, template's `_user-level/` staging as the propagation home) |
